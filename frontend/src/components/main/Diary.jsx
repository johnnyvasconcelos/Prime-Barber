...
const Diary = () => {
  ...
  useEffect(() => {
    fetch("https://prime-barber-dash.onrender.com/agenda")
  ...
  const enviar = (e) => {
    ...
    fetch("https://prime-barber-dash.onrender.com/agenda/adicionar", {
      method: "POST",
      headers: {
      ...
      .then(() => {
        return fetch("https://prime-barber-dash.onrender.com/agenda");
      })
      .then((resposta) => resposta.json())
      .then((dados) => {
        setAgendamentos(dados);
